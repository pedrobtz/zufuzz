...
static const R_CallMethodDef call_methods[] = {
    ...
    {"zufuzz_fdp_create", (DL_FUNC) &zufuzz_fdp_create, 1},
    {"zufuzz_fdp_remaining", (DL_FUNC) &zufuzz_fdp_remaining, 1},
    {"zufuzz_fdp_consumed", (DL_FUNC) &zufuzz_fdp_consumed, 1},
    {"zufuzz_fdp_bytes", (DL_FUNC) &zufuzz_fdp_bytes, 2},
    {"zufuzz_fdp_int", (DL_FUNC) &zufuzz_fdp_int, 2},
    {"zufuzz_fdp_int_in_range", (DL_FUNC) &zufuzz_fdp_int_in_range, 3},
    {"zufuzz_fdp_double_in_range", (DL_FUNC) &zufuzz_fdp_double_in_range, 3},
    {"zufuzz_fdp_probability", (DL_FUNC) &zufuzz_fdp_probability, 1},
    {"zufuzz_fdp_bool", (DL_FUNC) &zufuzz_fdp_bool, 1},
    {"zufuzz_fdp_double", (DL_FUNC) &zufuzz_fdp_double, 2},
    {"zufuzz_fdp_reset", (DL_FUNC) &zufuzz_fdp_reset, 1},
    {"zufuzz_utf8_filter", (DL_FUNC) &zufuzz_utf8_filter, 1},
